...
class Process implements Comparable<Process>
{
	...
	public Process(String name, int arrival_time, int burst_time) {
		...
		this.last_visited = this.arrival_time;
	}
...
public class SJF {
	...
	public void schedule()
	{
		...
		while(!this.processes.isEmpty())
		{
			...
			int temp = current_time+p.remaining_burst; 
			if(temp<=stop)
			{
			...
			else
			{
				...
				System.out.println("Executing partially-"+p.name+"for-"+(stop-current_time));
