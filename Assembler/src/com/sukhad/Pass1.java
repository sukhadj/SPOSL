...
public class Pass1 {
	...
	private void handle_operands(Instruction instr)
	{
		...
		else if(instr.op1!=null && instr.op1.matches("^='[0-9]+'$"))
		{
			...
			this.litTab.add(new Literal(instr.op1, -1));
		}
		...
		else if(instr.op2!=null && instr.op2.matches("^='[0-9]+'$"))
		{
			...
			this.litTab.add(new Literal(instr.op2, -1));
		}
